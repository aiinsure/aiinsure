...
sm_contract_file = os.path.join(BASE_DIR,'insureApp/smartcontract/license_smart_contract.teal')
clr_program_file = os.path.join(BASE_DIR,'insureApp/smartcontract/clear_program.teal')
